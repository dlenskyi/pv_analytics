    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "meter",
                    models.ForeignKey(
                        db_column="meter", on_delete=django.db.models.deletion.DO_NOTHING, to="initial_pv_data.meters"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "time_indexes_utc",
                    django.contrib.postgres.fields.ArrayField(base_field=models.DateTimeField(), blank=True, size=None),
                ),
                (
                    "energy",
                ...
                (
                    "site",
                    models.ForeignKey(
                        db_column="site", on_delete=django.db.models.deletion.DO_NOTHING, to="initial_pv_data.sites"
                    ),
                ),
            ],
            options={
